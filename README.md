# 面向对象  
  ...
  ```    
  方法三：使用Protected，只能通过this.getProtected("属性名")访问Protected属性。特殊情况使用方法一。
  ``` javascript  
  function Super() {
      var map = {'a':10,'super':20}
      this.enableProtectedProperty(map)
  }
  function Sub() {
      Super.apply(this)
      var map = {'a':12}
...
&nbsp;&nbsp;&nbsp;&nbsp;这是iOS很经典的MVC和MVVM设计模式图，可以应用到Android，理论上也可以应用到html应用。可能写惯了React或者Vue的朋友会
...
欢迎想贡献代码和提供测试帮助的朋友。  
项目地址：https://github.com/Ken-W-P-Huang/BC-S